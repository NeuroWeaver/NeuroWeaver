...
proc package_project {path_to_packaged kernel_vendor kernel_library kernel_name} {
  ...
  ipx::add_user_parameter "C_M01_PARAMBUF_AXI_DATA_WIDTH" $core
  set_property value_resolve_type user [ipx::get_user_parameters "C_M01_PARAMBUF_AXI_DATA_WIDTH" -of_objects $core]
  set_property value 128 [ipx::get_user_parameters "C_M01_PARAMBUF_AXI_DATA_WIDTH" -of_objects $core]
  ipx::add_user_parameter "C_M00_IMEM_AXI_DATA_WIDTH" $core
  set_property value_resolve_type user [ipx::get_user_parameters "C_M00_IMEM_AXI_DATA_WIDTH" -of_objects $core]
  set_property value 128 [ipx::get_user_parameters "C_M00_IMEM_AXI_DATA_WIDTH" -of_objects $core]
  ipx::add_user_parameter "C_M02_IBUF_AXI_DATA_WIDTH" $core
  set_property value_resolve_type user [ipx::get_user_parameters "C_M02_IBUF_AXI_DATA_WIDTH" -of_objects $core]
  set_property value 128 [ipx::get_user_parameters "C_M02_IBUF_AXI_DATA_WIDTH" -of_objects $core]
  ipx::add_user_parameter "C_M03_OBUF_AXI_DATA_WIDTH" $core
  set_property value_resolve_type user [ipx::get_user_parameters "C_M03_OBUF_AXI_DATA_WIDTH" -of_objects $core]
  set_property value 128 [ipx::get_user_parameters "C_M03_OBUF_AXI_DATA_WIDTH" -of_objects $core]
  }
