...
add_files [subst { $src_path/source/genesys_src/tag_sync.v \
   ...
   $src_path/source/genesys_src/genesys_b2b/instruction_memory_b2b.v \
   $src_path/source/genesys_src/ram_asymmetric.v \
   $src_path/source/genesys_src/parambuf_interface.v  
   $src_path/source/genesys_src/genesys_b2b/genesys_top_module_b2b.v \
   $src_path/source/genesys_src/genesys_b2b/obuf_interface_b2b.v \
   $src_path/source/genesys_src/genesys_b2b/decoder_b2b.v \
   $src_path/source/genesys_src/ram.v \
   $src_path/source/genesys_src/genesys_b2b/performance_counters_b2b.sv
   ...
   $src_path/source/genesys_src/genesys_b2b/instruction_memory_wrapper_b2b.v \
   $src_path/source/genesys_src/genesys_b2b/controller_b2b.sv \
   ...
   $src_path/source/simd_src/tanh_fixed.sv \              
   $src_path/source/simd_src/sigmoid_fixed.v    \               
   ...
   $src_path/source/simd_src/simd_ld_st_interface_simd4.v      \
...
#   set_property -dict [list CONFIG.C_PROBE2_WIDTH {4} CONFIG.C_PROBE1_WIDTH {4} CONFIG.C_PROBE0_WIDTH {4} \
   CONFIG.C_NUM_OF_PROBES {3} CONFIG.C_EN_STRG_QUAL {1} CONFIG.C_INPUT_PIPE_STAGES {2} \
   CONFIG.C_ADV_TRIGGER {true} CONFIG.ALL_PROBE_SAME_MU {FALSE} CONFIG.C_PROBE0_MU_CNT {4} \
   CONFIG.C_PROBE1_MU_CNT {4} CONFIG.C_PROBE2_MU_CNT {4}] [get_ips ila_1]

#   generate_target all [get_files  ./../genesys-systolic/source/xilinx_macros/ila_1.xci]
