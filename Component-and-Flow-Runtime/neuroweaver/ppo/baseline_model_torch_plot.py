...
if __name__ == '__main__':
    ...
    print('load process')
    #model = model.load("trained_models/PPO_exp_1000_pytorch0")
    #model = PPO.load("trained_models/testPPO_exp_1000_pytorch_test0")
    #model = PPO.load('trained_models/trained_model_1msteps.pkl')
    #model = PPO.load('trained_models/testPPOnew_env_1e7steps0')	
    #model = PPO.load('trained_models/testPPOsb1.0_1e7steps0')
    #model = PPO.load('trained_models/testPPOsb1.0_core4_5msteps0')
    #model = PPO.load('trained_models/PPOsb1.0verify_core4_0')
    #model = PPO.load('trained_models/PPOsb1.0verify_core4_0')
    #model = PPO.load("trained_models/PPOpposteps2048_5msteps_core1_0")
    #model = PPO.load("trained_models/PPOsb1.4nsteps2048_5msteps_core1_0")
    #model = PPO.load("trained_models/PPOsb1.4nsteps128_5msteps_core4_0")
    #model = PPO.load("trained_models/PPOsb1.4nsteps512_5msteps_core1_0")
    #model = PPO.load("trained_models/Compo_PPOsb1.4_nsteps512_5msteps")	
    #model = PPO.load("trained_models/Compo3_PPOsb1.4_nsteps512_1msteps")
    model = PPO.load("trained_models/Compo4_p1.5_PPOsb1.4_nsteps512_1msteps")
