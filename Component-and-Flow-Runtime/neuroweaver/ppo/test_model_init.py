...
parser.add_argument('--time_steps', type = int, default = 1000) # 5000000 #1e7
args = parser.parse_args()



exp_dir = './'+args.model_folder + '/' + args.algo + args.exp_name + "_core" + str(args.core) + "_" +str(args.seed)
...
if __name__ == '__main__':
    ...
    model = DDPG("MlpPolicy", env, verbose=1, tensorboard_log="MLP/")
