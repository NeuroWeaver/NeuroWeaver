...
with Component() as main:
    input_png = '/Users/joon/ohai.src/runtime/test.jpg'
    ...
    with Component(inputs=[tin], outputs=[out_tensors_d], state=[tf_weight_pickle]) as yolo_dnn:
        nodes, out_tensors = dnn.yolo_inference(tin, tf_weight_pickle)
        print(out_tensors[39].shape)
    ...
    my_touts = yolo_dnn(tin, weight_pickle)
